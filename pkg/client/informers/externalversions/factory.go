...
type SharedInformerFactory interface {
	...
	Certmanager() certmanager_k8s_io.Interface
}

func (f *sharedInformerFactory) Certmanager() certmanager_k8s_io.Interface {
	return certmanager_k8s_io.New(f, f.namespace, f.tweakListOptions)
}
